...
public class SimulationRobotsPompiers implements Simulable{
    ...
    private void draw() {
        ...
        gui.addGraphicalElement(new Text(200, 10, defaultColor, "carte : " + fichierCarte));
        ...
        for (Incendie incendie : donSimu.incendies) {
        	gui.addGraphicalElement(new Oval(incendie.getColonne()*30 + 50, incendie.getLigne()*30 + 50, Color.RED, Color.RED, 18, 18));;
        }
        

		for (Robot robot : donSimu.robots) {
			gui.addGraphicalElement(new Rectangle(robot.getColonne()*30 + 50, robot.getLigne()*30 + 50, Color.BLACK, Color.BLACK, 7, 7));;;
		}
    }
    ...
    private void incrementeDate() {
    	this.dateSimulation=dateSimulation+1;
    }
